...
### Functions associated specifically with the form processor (form_processor.php)

function validate_data($submit_to,$form_id,$not_ok_url,$send_text_email,$append_to_file, $data_file_name){
	...
	// If unspecified, data file name defaults to data_file.txt
